...
public class CustomRenderPipeline : RenderPipeline {
	...
	public class CameraRenderer 
	{
		...
		CustomRenderPipelineAsset m_pipelineAsset;
		...
		public void Render (ScriptableRenderContext context, Camera camera, CustomRenderPipelineAsset pipelineAsset) {
			m_context = context;
			m_camera = camera;
			m_pipelineAsset = pipelineAsset;
			m_cmd.name = "CustomRenderPipeline";
		...
		Shader   m_GBufferLigthingShader = Shader.Find("Unlit/DeferredLight");
